...
Due to limitations with the Pi Zero W, there are some known issues during the InkyPi installation process. The Pi Zero W (v1) is not a supported target — see the hardware matrix in [installation.md](./installation.md).
